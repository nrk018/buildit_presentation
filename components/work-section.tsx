...
const experiments = [
  {
    ...
    medium: "Step 1",
    description: "Students, faculty, and clubs log in using official university credentials on a single trusted platform.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Unified Announcements",
    medium: "Step 2",
    description: "All academic and non-academic announcements are posted in one centralized feed.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Event Creation & Management",
    medium: "Step 3",
    description: "Clubs and departments create events, manage registrations, and send real-time updates.",
    span: "col-span-1 row-span-2",
  },
  {
    title: "Smart Notifications",
    medium: "Step 4",
    description: "Users receive timely notifications so no deadline, update, or event is missed.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Role-Based Access",
    medium: "Step 5",
    description: "Different roles ensure students, faculty, and admins see what is relevant to them.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "Transparent Information Flow",
    medium: "Step 6",
    description: "All updates remain visible, searchable, and verified, reducing misinformation.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Engagement & Analytics",
    medium: "Step 7",
    description: "Universities track participation, engagement, and activity to improve decision-making.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Scalable University Ecosystem",
    medium: "Step 8",
    description: "UniSync grows with the university, supporting future features and integrations.",
    span: "col-span-1 row-span-1",
  },
]
