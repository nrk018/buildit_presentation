...
const experiments = [
  {
    ...
    medium: "Ft.1",
    description: "Send & receive money via UPI, bank, cards, and wallet",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Expense Tracking",
    medium: "Ft.2",
    description: "Manual entry for offline/cash expenses",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Saving Vault",
    medium: "Ft.3",
    description: "Secure Vault Keeper for sensitive records",
    span: "col-span-1 row-span-2",
  },
  {
    title: "AI Chatbot",
    medium: "Ft.4",
    description: "In-app AI chatbot for guidance and insights",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Payment Categorization",
    medium: "Ft.5",
    description: "Expense categorization & transaction history",
    span: "col-span-2 row-span-1",
  },
  {
    title: "Payment Reminders",
    medium: "Ft.6",
    description: "Lend money tracking with reminders",
    span: "col-span-1 row-span-1",
  },
  {
    title: "AI Financial Insights",
    medium: "Ft.7",
    description: "AI-powered personalized financial insights & analytics",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Password Protected Transactions",
    medium: "Ft.8",
    description: "Incognito transactions for privacy",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Splitting Payments",
    medium: "Ft.9",
    description: "Logging online/offline payment splits among people",
    span: "col-span-1 row-span-1",
  },
]
