  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Parallax</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Paavni Tandon</li>
            <li className="font-mono text-xs text-foreground/80">Dhruv Gupta</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Mrs. Harshika Mathur</li>
          </ul>
        </div>
      </div>
      ...
      >
        ...
        <p className="font-mono text-[10px] text-muted-foreground">DESIGN PORTFOLIO | PERSONALIZE CONTENT | SHOWCASE SKILLS</p>
      </div>

      {/* Feedback Form — replace the href with your actual form link and the label with something like "Give feedback". */}
      <div className="mt-12 text-center">
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLSfSMyYqpKIH5CrsI5NWs0y6oy8omnMXRSdMXF6QJgAADPFsiw/viewform?usp=header"
          target="_blank"
