  ...
  const mvps = [
    {
      number: "01",
      titleParts: [
        { text: "MVP 1: AI-powered personalized financial ", highlight: false },
        { text: "INSIGHTS ", highlight: true },
        { text: " & analytics ", highlight: false },
      ],
      description: "Monthly expense analysed using AI. Eg: You spent 22% of your monthly expense on food, 33% on travel, etc",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: "SPLIT ", highlight: true },
        { text: " Expense", highlight: false },
      ],
      description: "Split online/offline expenses with friends and groups. Eg: Two friend took gym or netflix together, they can log that payment on FinBuddy & clear confussions.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: "HIDDEN ", highlight: true },
        { text: " Transactions", highlight: false },
      ],
      description: "Password protected transactions for privacy",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: "SAFE VAULT", highlight: true },
        { text: " keeper", highlight: false },
      ],
      description: "Secure Vault Keeper for sensitive records & Safe keeping little shares of money.",
      align: "right",
    },
    {
      number: "05",
      titleParts: [
        ...
        { text: "LEND & ASK", highlight: true },
        { text: " money safely with reminders.", highlight: false },
      ],
      description: "Lend money tracking with reminders & due dates.",
      align: "left",
    },
  ]
